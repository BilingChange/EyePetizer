...
inline fun <reified VB : ViewBinding> RecyclerView.ViewHolder.withBinding(block: VB.(RecyclerView.ViewHolder) -> Unit) =
    apply {
...
inline fun <reified VB : ViewBinding> RecyclerView.ViewHolder.getBinding() =
    itemView.getBinding<VB>()
